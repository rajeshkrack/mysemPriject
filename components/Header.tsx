...
import { Menu, Coins, Leaf, Search, Bell, User, ChevronDown, LogIn, LogOut, CoinsIcon } from "lucide-react"
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
const web3auth = new Web3Auth({
  clientId: clientId || "",
  network: "sapphire_devnet", // Changed from SAPPHIRE_MAINNET to TESTNET
  privateKeyProvider
});
